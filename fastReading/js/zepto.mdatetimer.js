		...
		var picker = {
			init : function(){
				...
				if(!option.nowbtn){
					...
					// $('.mt_cancel', container).css('border-right', '1px solid #ccc');
				}
			...
			renderHTML : function(){
				...
				var html = '<div class="mt_mask"></div><div id="mdatetimer" class="mt_poppanel"><div class="mt_panel"><h3 class="mt_title">出生年月</h3><div class="mt_body"><div class="mt_year"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_month"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_day"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_sepline"></div><div class="mt_hour"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_minute"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_second"><ul><li class="mt_note"></li><li></li></ul></div><div class="mt_indicate"></div><div class="mt_indicate cate2"></div></div><div class="mt_confirm"><a href="javascript:void(0);" class="mt_cancel">取消</a><a href="javascript:void(0);" class="mt_ok">确定</a></div></div></div>';
